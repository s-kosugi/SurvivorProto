...
public class LevelUpBeamLight : MonoBehaviour
{
    [SerializeField] private SpriteRenderer sr;
    [SerializeField] private float growTime = 0.2f;  // 伸びる時間
    [SerializeField] private float fadeTime = 0.2f;  // 消える時間
    ...
    {
        // 光フォームのレベルアップ色
        sr.color = new Color(1f, 0.92f, 0.65f, 1f);
        // 初期スケール（伸びる前の状態）
